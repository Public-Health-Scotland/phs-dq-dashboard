...
The dashboard data is refreshed on a monthly basis. The majority of the dashboard data is extracted directly from SMR databases. All of the code to extract the data is in the `r here::here("code")` folder.
...
+ open *`r here::here("admin", "create_credentials.R")`*
